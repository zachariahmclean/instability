...
If any of the ladders are incorrect, we can use fix_ladders_auto() to automatically fix it, or fix_ladders_manual() to manually fix it in the worst case scenario.
