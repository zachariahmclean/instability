...
testthat::test_that("main peaks bp_fragments", {
  ...
  testthat::expect_true(
    test_main_peaks$allele_2_size == 131.94,
...
testthat::test_that("add_repeats", {
  ...
  testthat::expect_true(
    round(test_repeats_main_peaks$allele_2_repeat, 2) == 14.98,
...
testthat::test_that("instability metrics", {
  ...
  testthat::expect_true(round(test_metrics$instability_index, 2) == 0.51)
  testthat::expect_true(round(test_metrics$instability_index_abs, 2) == 4.25)
  testthat::expect_true(round(test_metrics$expansion_index, 2) == 4.38)
  testthat::expect_true(round(test_metrics$expansion_ratio, 2) == 6.5)
  testthat::expect_true(round(test_metrics$contraction_index, 2) == -3.54)
